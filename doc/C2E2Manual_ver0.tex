...
\begin{marginfigure}
\centerline{\includegraphics[scale=.24,keepaspectratio=true]{Images/Frontend.png}}
...
\begin{marginfigure}
\centerline{\includegraphics[scale=.24,keepaspectratio=true]{Images/refine.png}}
...
\begin{figure}[!htbp]
 \centerline{\includegraphics[scale=.25,keepaspectratio=true]{./Images/Plot_display.jpg}}
