...
public:
  ...
  DMatrix(size_type rows,size_type cols, const ScalarType data[])
    : m_M(rows,cols,data)
  {}
  ...
  DMatrix(size_type rows,size_type cols,bool b)
    : m_M(rows,cols,b)
  {}
  ...
  double* at(size_type i,size_type j){
    return m_M.at(i,j);
  }
  const double* at(size_type i,size_type j) const{
    return m_M.at(i,j);
  }

  //operations on matrices
  static DMatrix Identity(size_type dimension){
