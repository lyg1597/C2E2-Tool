...
void makeTests(ITaylor &T, const IVector & x0)
{
  ...
  rootFrame.Clear();
  rootFrame << "C0GraphicalSet(Intv2Set)     size = " << maxDiam(IVector(set0)) << "\n\n"
            << "C0GraphicalSet(C0RectSet)    size = " << maxDiam(IVector(set1)) << "\n\n"
            << "C0GraphicalSet(C0Rect2Set)   size = " << maxDiam(IVector(set2)) << "\n\n"
            << "C1GraphicalSet(C1Rect2Set)   size = " << maxDiam(IVector(set3)) << "\n\n";
}
