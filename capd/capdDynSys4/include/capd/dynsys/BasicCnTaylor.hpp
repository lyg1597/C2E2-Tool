...
BasicCnTaylor<MapT,StepControlT,CurveT>::~BasicCnTaylor(){}
...
typename BasicCnTaylor<MapType, StepControlType, CurveT>::VectorType
BasicCnTaylor<MapType, StepControlType, CurveT>::operator()(VectorType v)
{
...
template <typename MapT, typename StepControlT,typename CurveT>
typename BasicCnTaylor<MapT,StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT,StepControlT,CurveT>::operator()(VectorType v,MatrixType& der)
{
...
template <typename MapT, typename StepControlT,typename CurveT>
typename BasicCnTaylor<MapT,StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT,StepControlT,CurveT>::operator()(VectorType v,MatrixType& der, HessianType& hessian)
{
  // set initial condition
  for(size_type i=0;i<this->dimension();++i)
  {
...
template <typename MapT, typename StepControlT,typename CurveT>
typename BasicCnTaylor<MapT,StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT,StepControlT,CurveT>::operator()(CnCoeffType& coeff)
{
  this->setCurrentTime(coeff.getCurrentTime());
  this->setInitialCondition(coeff);
  this->evalAndSum(coeff);
  coeff.setCurrentTime(coeff.getCurrentTime()+this->m_step);
...
template <typename MapType, typename StepControlType, typename CurveT>
void BasicCnTaylor<MapType, StepControlType, CurveT>::setOrder(size_type order)
{
...
template <typename MapType, typename StepControlType, typename CurveT>
typename BasicCnTaylor<MapType, StepControlType, CurveT>::ScalarType
BasicCnTaylor<MapType, StepControlType, CurveT>::getCoeffNorm(size_type r, size_type degree) const
{
...
template <typename MapT, typename StepControlT,typename CurveT>
void BasicCnTaylor<MapT,StepControlT,CurveT>::evalAndSum(VectorType& v,MatrixType& der, HessianType& hessian)
{
  size_type i,j,c;
...
template <typename MapT, typename StepControlT,typename CurveT>
void BasicCnTaylor<MapT,StepControlT,CurveT>::evalAndSum(VectorType& v,MatrixType& der)
{
  size_type i,j;
...
template <typename MapT, typename StepControlT,typename CurveT>
void BasicCnTaylor<MapT,StepControlT,CurveT>::evalAndSum(VectorType& v)
{
  int r=this->getOrder();
...
template <typename MapT, typename StepControlT,typename CurveT>
void BasicCnTaylor<MapT,StepControlT,CurveT>::evalAndSum(CnCoeffType& v)
{
  ...
  for(size_type i=0;i<this->dimension();++i)
  {
    ...
    typename CnCoeffType::iterator b = v.begin(i), e = v.end(i);
    for(;b!=e;++b,++p)
      *b = *p;
...
template <typename MapT, typename StepControlT,typename CurveT>
void BasicCnTaylor<MapT,StepControlT,CurveT>::setInitialCondition(const CnCoeffType& v)
{
  for(size_type i=0;i<this->dimension();++i)
  {
    typename CnCoeffType::const_iterator b = v.begin(i), e=v.end(i);
...
template <typename MapType, typename StepControlType, typename CurveT>
const typename BasicCnTaylor<MapType, StepControlType, CurveT>::SolutionCurve&
BasicCnTaylor<MapType, StepControlType, CurveT>::getCurve()
{
