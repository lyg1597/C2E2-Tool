...
>
class BasicC2Taylor : public virtual BasicTaylor<MapT, StepControlT, CurveT>{
public:
  ...
  BasicC2Taylor(MapType& vectorField, size_type order, const StepControlT& stepControl = StepControlT());
  ...
  void operator()(JetT& jet){
    C2JetMove<BasicC2Taylor,JetT>::move(jet,*this);
  }
...
protected:
  BasicC2Taylor(const BasicC2Taylor& t) : BaseTaylor(t){}
...
inline typename BasicC2Taylor<MapType, StepControlType,CurveT>::VectorType
BasicC2Taylor<MapType, StepControlType,CurveT>::operator()(ScalarType& t, const VectorType &v, MatrixType& der, HessianType& coeff)
{
...
template <typename MapType, typename StepControlType,typename CurveT>
inline typename BasicC2Taylor<MapType,StepControlType,CurveT>::VectorType
BasicC2Taylor<MapType,StepControlType,CurveT>::operator()(
