...
BasicC2Taylor<MapType,StepControlType,CurveT>::BasicC2Taylor(
      MapType& vectorField,
      size_type order,
...
template <typename MapType, typename StepControlType,typename CurveT>
typename BasicC2Taylor<MapType,StepControlType,CurveT>::VectorType
BasicC2Taylor<MapType,StepControlType,CurveT>::operator()(VectorType v,MatrixType& der, HessianType& hessian)
{
...
template <typename MapType, typename StepControlType,typename CurveT>
void BasicC2Taylor<MapType,StepControlType,CurveT>::sumTaylorSeries(
      VectorType& v,
      MatrixType& der,
      HessianType& hessian,
      VectorType* coeff,
