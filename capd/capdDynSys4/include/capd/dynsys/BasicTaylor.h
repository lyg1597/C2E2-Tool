...
>
class BasicTaylor :  public capd::dynsys::StepControlInterface<StepControlT,typename MapT::ScalarType>, public CurveT {
public:
  ...
  BasicTaylor(MapType& field, size_type order, const StepControlT& stepControl = StepControlT());
  ...
  void operator()(JetT& jet){
	  C1JetMove<BasicTaylor,JetT>::move(jet,*this);
  }
...
inline const MapType& BasicTaylor<MapType, StepControlType, CurveT>::getVectorField() const {
  return *m_vField;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline MapType& BasicTaylor<MapType, StepControlType, CurveT>::getVectorField() {
  return *m_vField;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline const typename BasicTaylor<MapType, StepControlType, CurveT>::ScalarType&
BasicTaylor<MapType, StepControlType, CurveT>::getStep() const {
  return m_step;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicTaylor<MapType, StepControlType, CurveT>::setStep(const ScalarType& newStep) {
  m_step = newStep;
  this->turnOffStepControl();
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicTaylor<MapType, StepControlType, CurveT>::adjustTimeStep(const ScalarType& newStep) {
  m_step = newStep;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicTaylor<MapType, StepControlType, CurveT>::computeTimeStep(VectorType& v) {
...
template <typename MapType, typename StepControlType, typename CurveT>
inline typename BasicTaylor<MapType, StepControlType, CurveT>::VectorType
BasicTaylor<MapType, StepControlType, CurveT>::operator()(ScalarType& t, const VectorType &iv)
{
...
template <typename MapType, typename StepControlType, typename CurveT>
inline typename BasicTaylor<MapType, StepControlType, CurveT>::VectorType
BasicTaylor<MapType, StepControlType, CurveT>::operator()(ScalarType& t, const VectorType &v, MatrixType& der)
{
  this->setCurrentTime(t);
...
template <typename MapType, typename StepControlType, typename CurveT>
inline typename BasicTaylor<MapType, StepControlType, CurveT>::VectorType
BasicTaylor<MapType, StepControlType, CurveT>::operator()(ScalarType& t,  const VectorType &v, const MatrixType& derivative, MatrixType & resultDerivative)
{
  this->setCurrentTime(t);
...
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficientsAtCenter(const VectorType& x, size_type order)
{
...
template<typename MapType, typename StepControlType,typename CurveType>
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficientsAtCenter(ScalarType t, const VectorType& x, size_type order)
{
  this->setCurrentTime(t);
...
template<typename MapType, typename StepControlType,typename CurveType>
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficients(const VectorType& x, size_type order)
{
...
template<typename MapType, typename StepControlType,typename CurveType>
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficients(ScalarType t, const VectorType& x, size_type order)
{
  this->setCurrentTime(t);
...
template<typename MapType, typename StepControlType,typename CurveType>
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficients(const VectorType& x, const MatrixType& M, size_type order)
{
  VectorType* coeff = this->getCoefficients();
  MatrixType* matrixCoeff = this->getMatrixCoefficients();
  coeff[0] = x;
...
template<typename MapType, typename StepControlType,typename CurveType>
inline void BasicTaylor<MapType,StepControlType,CurveType>::computeCoefficients(ScalarType t,const VectorType& x, const MatrixType& M, size_type order)
{
  this->setCurrentTime(t);
