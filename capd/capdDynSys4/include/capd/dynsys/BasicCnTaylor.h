...
template <
  ...
  >
class BasicCnTaylor :  public capd::dynsys::StepControlInterface<StepControlT,typename MapT::ScalarType>, public CurveT {
public:
  ...
  typedef capd::diffAlgebra::CnCoeff<MatrixType,0> CnCoeffType;
  typedef typename CnCoeffType::Multipointer Multipointer;
  typedef typename CnCoeffType::Multiindex Multiindex;
  typedef typename MatrixType::size_type size_type;

  BasicCnTaylor(MapType& a_vectorField, size_type a_order, const StepControlT& stepControl = StepControlT()); // degree will be read form vectorField object
  ...
  void operator()(JetT& jet){
	  CnJetMove<BasicCnTaylor,JetT>::move(jet,*this);
  }
...
protected:
  ...
  BasicCnTaylor(const BasicCnTaylor& s) : CurveT(0,0,1,1,1){}
...
inline const MapType& BasicCnTaylor<MapType, StepControlType, CurveT>::getVectorField() const {
  return *m_vField;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline MapType& BasicCnTaylor<MapType, StepControlType, CurveT>::getVectorField() {
  return *m_vField;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline typename BasicCnTaylor<MapType, StepControlType, CurveT>::ScalarType
BasicCnTaylor<MapType, StepControlType, CurveT>::getStep() const {
  return m_step;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicCnTaylor<MapType, StepControlType, CurveT>::setStep(const ScalarType& newStep) {
  m_step = newStep;
  this->turnOffStepControl();
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicCnTaylor<MapType, StepControlType, CurveT>::adjustTimeStep(const ScalarType& newStep) {
  m_step = newStep;
}

template <typename MapType, typename StepControlType, typename CurveT>
inline void BasicCnTaylor<MapType, StepControlType, CurveT>::computeTimeStep(const VectorType& v) {
...
inline typename BasicCnTaylor<MapT, StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT, StepControlT,CurveT>::operator()(ScalarType& t, const VectorType &v)
{
...
template <typename MapT, typename StepControlT,typename CurveT>
inline typename BasicCnTaylor<MapT, StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT, StepControlT,CurveT>::operator()(ScalarType& t, const VectorType &v, MatrixType& der)
{
  this->setCurrentTime(t);
...
template <typename MapT, typename StepControlT,typename CurveT>
inline typename BasicCnTaylor<MapT, StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT, StepControlT,CurveT>::operator()(ScalarType& t, const VectorType &v, MatrixType& der, HessianType& coeff)
{
  this->setCurrentTime(t);
...
template <typename MapT, typename StepControlT,typename CurveT>
inline typename BasicCnTaylor<MapT, StepControlT,CurveT>::VectorType
BasicCnTaylor<MapT, StepControlT,CurveT>::operator()(
...
template <typename MapT, typename StepControlT,typename CurveT>
inline typename BasicCnTaylor<MapT, StepControlT,CurveT>::size_type
BasicCnTaylor<MapT, StepControlT,CurveT>::degree() const
{
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficientsAtCenter(const VectorType& x, size_type order)
{
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficientsAtCenter(ScalarType t, const VectorType& x, size_type order)
{
  this->setCurrentTime(t);
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficients(const VectorType& x, size_type order)
{
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficients(ScalarType t, const VectorType& x, size_type order)
{
  this->setCurrentTime(t);
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficients(const VectorType& x, const MatrixType& M, size_type order)
{
  // set initial condition
  for(size_type i=0;i<this->dimension();++i)
  {
...
template <typename MapT, typename StepControlT,typename CurveT>
inline void BasicCnTaylor<MapT, StepControlT,CurveT>::computeCoefficients(ScalarType t, const VectorType& x, const MatrixType& M, size_type order)
{
  this->setCurrentTime(t);
