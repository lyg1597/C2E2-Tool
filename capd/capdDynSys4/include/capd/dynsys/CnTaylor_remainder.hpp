...
CnTaylor<MapType,StepControlType,CurveType>::Remainder(const ScalarType& t, const VectorType &iv, VectorType& o_enc)
{
...
template<typename MapType, typename StepControlType,typename CurveType>
void CnTaylor<MapType,StepControlType,CurveType>::JacRemainder(
      const ScalarType& t,
...
void CnTaylor<MapType,StepControlT,CurveT>::c2Remainder(
