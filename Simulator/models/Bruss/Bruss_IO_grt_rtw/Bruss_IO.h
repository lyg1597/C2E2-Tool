...
typedef struct {
  real_T FromFile[2];                  /* '<Root>/From File' */
  real_T x_out;                        /* '<Root>/Chart' */
  real_T y_out;                        /* '<Root>/Chart' */
} B_Bruss_IO_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T lastMajorTime;                /* '<Root>/Chart' */
  struct {
    void *PrevTimePtr;
  ...
  uint8_T is_c1_Bruss_IO;              /* '<Root>/Chart' */
} DW_Bruss_IO_T;
...
/* Block signals (auto storage) */
extern B_Bruss_IO_T Bruss_IO_B;

/* Continuous states (auto storage) */
extern X_Bruss_IO_T Bruss_IO_X;

/* Block states (auto storage) */
extern DW_Bruss_IO_T Bruss_IO_DW;

/* Model entry point functions */
extern void Bruss_IO_initialize(void);
extern void Bruss_IO_step(void);
extern void Bruss_IO_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Bruss_IO_T *const Bruss_IO_M;
