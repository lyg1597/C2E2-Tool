...
switch user_input
    ...
    case 5 % closed-loop lean case excursion (formula 30)
        c25 = 0.95;
        c23= 0.95;
        c24 = 0.99;   
        Ut = Cl;
    ...
    case 7 % open-loop power mode performance (formula 32)
        initial_cond = [61.3 81.2;10 20];
        Ut = 0.2;
        phi = '[] (pwr -> (utl /\ utr))';
       
    case 8 % open-loop startup and sensor_fail modes performance (formula 33)
        fault_time = 15;
